...
{
    [0 + NUM_PAINTING_CAPTIONS * CONTEST_CATEGORY_COOL]   = COMPOUND_STRING("炫酷无止境——\n令人钉住的{STR_VAR_1}"),
    [1 + NUM_PAINTING_CAPTIONS * CONTEST_CATEGORY_COOL]   = COMPOUND_STRING("嘿！\n帅气宝可梦{STR_VAR_1}"),
    [2 + NUM_PAINTING_CAPTIONS * CONTEST_CATEGORY_COOL]   = COMPOUND_STRING("令人叹为观止的\n伟大{STR_VAR_1}"),
    [0 + NUM_PAINTING_CAPTIONS * CONTEST_CATEGORY_BEAUTY] = COMPOUND_STRING("本世纪最美的维纳斯——\n美丽的{STR_VAR_1}"),
    [1 + NUM_PAINTING_CAPTIONS * CONTEST_CATEGORY_BEAUTY] = COMPOUND_STRING("{STR_VAR_1}的\n闪闪登登的笑容"),
    [2 + NUM_PAINTING_CAPTIONS * CONTEST_CATEGORY_BEAUTY] = COMPOUND_STRING("宝可梦中心超级偶像——\n无与伦比的{STR_VAR_1}"),
    [0 + NUM_PAINTING_CAPTIONS * CONTEST_CATEGORY_CUTE]   = COMPOUND_STRING("甜美可爱的{STR_VAR_1}"),
    [1 + NUM_PAINTING_CAPTIONS * CONTEST_CATEGORY_CUTE]   = COMPOUND_STRING("漂亮的{STR_VAR_1}\n的获奖画像"),
    [2 + NUM_PAINTING_CAPTIONS * CONTEST_CATEGORY_CUTE]   = COMPOUND_STRING("对我们眨眨眼！\n可爱宝可梦{STR_VAR_1}"),
    [0 + NUM_PAINTING_CAPTIONS * CONTEST_CATEGORY_SMART]  = COMPOUND_STRING("聪明大师——\n睿智宝可梦{STR_VAR_1}"),
    [1 + NUM_PAINTING_CAPTIONS * CONTEST_CATEGORY_SMART]  = COMPOUND_STRING("{STR_VAR_1}——\n被选中的最强宝可梦"),
    [2 + NUM_PAINTING_CAPTIONS * CONTEST_CATEGORY_SMART]  = COMPOUND_STRING("{STR_VAR_1}的\n优雅时刻"),
    [0 + NUM_PAINTING_CAPTIONS * CONTEST_CATEGORY_TOUGH]  = COMPOUND_STRING("肌肉发达的\n速度之星{STR_VAR_1}"),
    [1 + NUM_PAINTING_CAPTIONS * CONTEST_CATEGORY_TOUGH]  = COMPOUND_STRING("强壮又更强壮的\n最强{STR_VAR_1}"),
    [2 + NUM_PAINTING_CAPTIONS * CONTEST_CATEGORY_TOUGH]  = COMPOUND_STRING("强大粗犷的\n超级宝可梦{STR_VAR_1}"),
};
