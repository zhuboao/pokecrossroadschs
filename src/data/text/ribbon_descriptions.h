const u8 gRibbonDescriptionPart1_Champion[] = _("打败冠军并登入");
...
const u8 gRibbonDescriptionPart2_NormalRank[] = _("普通级的冠军！");
const u8 gRibbonDescriptionPart2_SuperRank[] = _("高手级的冠军！");
const u8 gRibbonDescriptionPart2_HyperRank[] = _("究极级的冠军！");
const u8 gRibbonDescriptionPart2_MasterRank[] = _("大师级的冠军！");
...
const u8 gRibbonDescriptionPart2_Victory[] = _("冠军时得到的奖章。");
