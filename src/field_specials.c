...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    {
        COMPOUND_STRING("飞吻海报10年{CLEAR_TO 0x5E}16BP"),
        ...
        COMPOUND_STRING("小锋鳄玩偶{CLEAR_TO 0x5E}80BP"),
        gText_Exit
    },
    ...
    [SCROLL_MULTI_BF_MOVE_TUTOR_1] =
    {
        ...
        COMPOUND_STRING("岩清{CLEAR_TO 0x4E}48BP"),
    ...
    [SCROLL_MULTI_BF_MOVE_TUTOR_2] =
    {
        ...
        COMPOUND_STRING("挡住{CLEAR_TO 0x4E}48BP"),
