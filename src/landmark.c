...
static const struct Landmark Landmark_NewMauville = {COMPOUND_STRING("新紫堵"), FLAG_LANDMARK_NEW_MAUVILLE};
static const struct Landmark Landmark_TrickHouse = {COMPOUND_STRING("戟法屋"), FLAG_LANDMARK_TRICK_HOUSE};
...
static const struct Landmark Landmark_GlassWorkshop = {COMPOUND_STRING("琉璐工坊"), FLAG_LANDMARK_GLASS_WORKSHOP};
...
static const struct Landmark Landmark_IslandCave = {COMPOUND_STRING("小岛洞窟"), FLAG_LANDMARK_ISLAND_CAVE};
